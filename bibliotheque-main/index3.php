        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo $section == 'livres' ? 'active' : ''; ?>" href="?section=livres">Livres</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $section == 'utilisateurs' ? 'active' : ''; ?>" href="?section=utilisateurs">Utilisateurs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $section == 'emprunts' ? 'active' : ''; ?>" href="?section=emprunts">Emprunts</a>
                    </li>
                </ul>
